...
// Module: Imscribing.Millennium.PerfectCuboid.FactorizationLemma
// Imports: public import Init public import Imscribing.Millennium.PerfectCuboid public import Imscribing.Millennium.PerfectCuboid.PrerequisiteLemmasL5_L7 public import Mathlib.Data.Nat.Basic public import Mathlib.Data.Nat.GCD.Basic public import Mathlib.Data.Int.Basic public import Mathlib.Data.Int.GCD public import Mathlib.NumberTheory.PythagoreanTriples public import Mathlib.Tactic
#include <lean/lean.h>
...
lean_object* initialize_imscribing_x2dlean_Imscribing_Millennium_PerfectCuboid_PrerequisiteLemmasL5__L7(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_imscribing_x2dlean_Imscribing_Millennium_PerfectCuboid_FactorizationLemma(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_imscribing_x2dlean_Imscribing_Millennium_PerfectCuboid_PrerequisiteLemmasL5__L7(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
